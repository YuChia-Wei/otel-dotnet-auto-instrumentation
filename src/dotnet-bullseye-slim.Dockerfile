...
FROM base AS otel
COPY OpenTelemetry.dotnet.AutoInstrumentation.Release/linux-glibc-1.0.2.tar.gz otel-dotnet-instrumentation.tar.gz
RUN tar -xzvf otel-dotnet-instrumentation.tar.gz && mv linux-glibc-1.0.2 otel-dotnet-auto
